...
//     // const [selectedICard, setSelectedICard] = useState([]);
...
//                 <div className='w-11/12 mx-auto grid sm:grid-cols-3 gap-3'>
//                     {
//                         data.map((data) => {
...
//                                         >
//                                             {selectedItems.includes(data.id) ? "Selected" : "Buy Now"}
//                                         </button>
//                                     </div>
//                                 </div>
//                             </div>);
...
//                 <YourCard selectedICard={selectedICard}></YourCard>}
